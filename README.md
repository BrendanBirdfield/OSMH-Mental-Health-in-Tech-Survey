...
This data was then processed in python. Each year's survey was loaded as a CSV. A selection of survey questions were selected and each column name representing each question was processed to be consitent in format. 
...
The second page focuses on how employer's approaches to mental health have changed over time and comparisons of business size and these approaches. This included mental health care coverage, providing mental health resources and how comfortable employees felt approaching their direct supervisors about their mental health concerns.
